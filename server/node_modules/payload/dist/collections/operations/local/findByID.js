...
async function findByIDLocal(payload, options) {
    var _a, _b, _c, _d, _e;
    const { collection: collectionSlug, depth, currentDepth, id, locale = null, fallbackLocale = null, user, overrideAccess = true, disableErrors = false, showHiddenFields, req = {}, draft = false, } = options;
