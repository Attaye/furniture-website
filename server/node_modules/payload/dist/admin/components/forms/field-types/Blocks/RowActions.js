...
const RowActions = (props) => {
    const { addRow, duplicateRow, removeRow, moveRow, labels, blocks, rowIndex, rowCount, blockType, } = props;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(ArrayAction_1.ArrayAction, { rowCount: rowCount, addRow: () => {
