...
export type FieldAction = REPLACE_STATE | REMOVE | MODIFY_CONDITION | UPDATE | REMOVE_ROW | ADD_ROW | DUPLICATE_ROW | MOVE_ROW | SET_ROW_COLLAPSED | SET_ALL_ROWS_COLLAPSED;
